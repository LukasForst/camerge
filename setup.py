...
setup(
    ...
    description="Merge multiple ical/ics calendars to one.",  # Optional
    ...
    url="https://github.com/LukasForst/camerge",  # Optional
    # This should be your name or the name of the organization which owns the
    # project.
    author="Lukas Forst",  # Optional
    # This should be a valid email address corresponding to the author listed
    # above.
    author_email="lukas@forst.dev",  # Optional
    ...
    # larger catalog.
    keywords="calendar calendaring ical icalendar merge calendar-merge anonymization",  # Optional
